...
def get_settings_from_env(controller_port=None,
    ...
    to enable backwards compatibility with previous versions of this script:
        visualization_server_image: dockerhub.enlightencloud.local/ml-pipeline/visualization-server
        visualization_server_tag: value of KFP_VERSION environment variable
        frontend_image: dockerhub.enlightencloud.local/ml-pipeline/frontend
    ...
    settings["visualization_server_image"] = \
        ...
        os.environ.get("VISUALIZATION_SERVER_IMAGE", "dockerhub.enlightencloud.local/ml-pipeline/visualization-server")

    settings["frontend_image"] = \
        frontend_image or \
        os.environ.get("FRONTEND_IMAGE", "dockerhub.enlightencloud.local/ml-pipeline/frontend")
